...
from semantic_uncertainty.semantic_uncertainty.uncertainty.models.huggingface_models import HuggingfaceModel
from semantic_uncertainty.semantic_uncertainty.uncertainty.utils import openai as oai
from semantic_uncertainty.semantic_uncertainty.uncertainty.utils import utils
...
def get_semantic_ids(strings_list, model, strict_entailment=False, example=None):
    ...
    print(f"Number of semantic ids: {len(set(semantic_set_ids))} {semantic_set_ids=}")
...
def cluster_assignment_entropy(semantic_ids):
    ...
    print(f"Cluster assignment entropy: {n_generations=} {counts=} {semantic_ids=} {entropy=} ")
    return entropy
